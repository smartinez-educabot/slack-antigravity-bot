 ...
 * Incluye todos los scopes necesarios para Antigravity Cloud Code
 * y la API de Generative Language como fallback.
 */
    ...
    return res.status(200).send(`
      <html>
        ...
        <body style="font-family: system-ui; max-width: 700px; margin: 40px auto; padding: 20px;">
          ...
          <h3>Scopes otorgados:</h3>
          <pre style="background:#f5f5f5; padding:10px; font-size:12px; overflow-x:auto;">${tokens.scope || "No reportados"}</pre>
          
          <h3>Pasos siguientes:</h3>
          <ol>
            <li>Andá a tu proyecto en <a href="https://vercel.com" target="_blank">Vercel</a></li>
            <li>Settings → Environment Variables</li>
            <li>Actualizá <code>GOOGLE_ACCESS_TOKEN</code> y <code>GOOGLE_REFRESH_TOKEN</code></li>
